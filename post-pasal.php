...
<body>
    <?php 
            ...
            if($pasal != ''){
                mysqli_query($koneksi, "INSERT INTO pasal(pasal) VALUES('".$pasal."') ");                
                   header('location: index-pasal.php?sukses=tambah');                              
                    ...
                    <div class="card-body">
                        <form method="post" action="">
                            ...
                            <div class="mb-1">
                                ...
                                <textarea id="textarea" name="pasal" class="form-control"></textarea><br>
                            </div>
