...
<html>
 ...
 <form action="" method="post">
  ...
  <input class="input is-link" type="text" name="search" id="search" placeholder="Search Pasal..">
...
<div class="content">
<p><center>SALINAN PERATURAN OTORITAS JASA KEUANGAN</center>
<center><strong>NOMOR 4/POJK.03/2015</strong></center>
<center>TENTANG PENERAPAN TATA KELOLA BAGI BANK PERKREDITAN RAKYAT</center></p></div>
 ...
 $data = mysqli_query($koneksi,"select * from pasal");
 ...
 $id = $_GET['id'];
 $query = mysqli_query($koneksi,"SELECT * FROM pasal WHERE pasal LIKE '%".$keyword."%' OR ".$no." LIKE '%".$keyword."%'  ORDER BY id DESC Limit $halaman_awal,$batas");
 ...
 <td class="readmore"><?php  echo $data['pasal'];?></td>
 <td class="align-center"><a class="button is-light" href="hapus-pasal.php?id=<?php echo $data['id'];?>">hapus</a></td>
 <td class="align-center"><a class="button is-light" href="post-edit-pasal.php?id=<?php echo $data['id'];?>">Edit</a></td>
...
<?php 
 ...
 ?>		
  ...
  <p>
  <p class="subtitle">
           PERUMDA <b>BPR</b><strong><br>BANK CIREBON</strong>
           </p>
    </p>
  </div>
  </footer>
